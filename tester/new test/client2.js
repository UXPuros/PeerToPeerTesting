...
var name = ""; 
 connection.onopen = () =>{ console.log('hi')}
...
function onLogin(success) { 
   ...
   if (success === false) { 
    ...
    //   myConnection.ondatachannel = (who)=>{console.log('uwu', who)}
      //setup ice handling
...
connectToOtherUsernameBtn.addEventListener("click", function () { 
 ...
 function onAnswer(answer) { 
    console.log('i am the answer', answer)
...
function openDataChannel() { 
 ...
 sendMsgBtn.addEventListener("click", function (event) { 
   ...
   //  console.log(val.readUInt8(0))
    const buffer = Buffer.alloc(1)
    val = buffer.readUInt8(0)
